 ...
 * @since 1.0
 */
class Pentax_projects extends Widget_Base {

	public function get_name() {
		return 'pentax-projects';
	}

	public function get_title() {
		return __( 'Projects', 'pentax' );
	}
	...
	protected function _register_controls() {
        ...
        $this->add_control(
            ...
            [
                ...
                'label_block'   => true,
                'default'       => __( 'Our <span>Recent</span> Project', 'pentax' )
            ]
        );
        $this->add_control(
            'sec_subtitle', [
        ...
        $this->start_controls_section(
            'menu_tab_sec',
            [
                'label' => __( 'Projects', 'pentax' ),
            ]
        );
		$this->add_control(
			'portfolio_number', [
				'label'         => esc_html__( 'Portfolio Number', 'pentax' ),
        ...
        $this->start_controls_section(
            'style_title', [
                'label' => __( 'Style Category', 'pentax' ),
        ...
        $this->add_control(
            'color_title', [
                'label'     => __( 'Category Title Color', 'pentax' ),
                'type'      => Controls_Manager::COLOR,
                'default'   => '#222',
                'selectors' => [
        ...
        $this->add_control(
            'cat_title_hover', [
                'label'     => __( 'Category Item Hover Color', 'pentax' ),
                'type'      => Controls_Manager::COLOR,
                'default'   => '',
                'selectors' => [
        ...
        $this->add_control(
            'active_cat_title_color', [
                'label'     => __( 'Active Category Title Color', 'pentax' ),
                'type'      => Controls_Manager::COLOR,
                'default'   => '',
                'selectors' => [
        ...
        $this->start_controls_section(
            'style_tab', [
                'label' => __( 'Style Menu Item', 'pentax' ),
                'tab'   => Controls_Manager::TAB_STYLE,
            ]
        );
        $this->add_control(
            'color_menu_item_color', [
                'label'     => __( 'Menu Item Color', 'pentax' ),
                'type'      => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->add_control(
            'color_menu_item', [
                'label'     => __( 'Menu Item Background Color', 'pentax' ),
                'type'      => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->add_control(
            'color_menu_item_hover', [
                'label'     => __( 'Menu Item Hover Background Color', 'pentax' ),
                'type'      => Controls_Manager::COLOR,
                'selectors' => [
    ...
    ?>
        <section class="portfolio_area area-padding" id="portfolio">
            <div class="container">
                ...
                <?php
                pentax_portfolio_section( $pNumber );
                ?>
