 ...
 * @since 1.0
 */
class Pentax_Features extends Widget_Base {

	public function get_name() {
		return 'pentax-features';
	}

	public function get_title() {
		return __( 'Features', 'pentax' );
	}
	...
	protected function _register_controls() {
		...
		$this->start_controls_section(
			'features_block',
			[
				'label' => __( 'Features', 'pentax' ),
			]
		);
		$this->add_control(
            'features_content', [
                'label' => __( 'Create Features', 'pentax' ),
                ...
                'fields' => [
                    [
                        ...
                        'label_block' => true,
                        'default' => __('Money back gurantee', 'pentax')
                    ],
	                [
		                'name'  => 'desc',
		                'label' => __( 'Description', 'pentax' ),
                        'type'  => Controls_Manager::TEXTAREA,
                        'default' => __('Shall open divide a one', 'pentax')
	                ],
                    [
		                'name'  => 'icon',
        ...
        $this->start_controls_section(
            'style_features', [
                'label' => __( 'Style Features', 'pentax' ),
        ...
        $this->add_control(
            ...
            [
                'label'     => __( 'Style Feature Title ', 'pentax' ),
        ...
        $this->add_control(
            'title_hover_bg', [
                'label' => __( 'Feature Hover Border Color', 'pentax' ),
                'type'  => Controls_Manager::COLOR,
                'default' => '#eff2f3',
                'selectors' => [
