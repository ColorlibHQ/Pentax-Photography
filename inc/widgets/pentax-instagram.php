...
----------------------------------------*/
class pentax_instagram_photo extends WP_Widget {
	public function __construct(){
		parent::__construct('pentax_instagram_photo',esc_html__('[ Pentax ] Intagram Photo','pentax'),array(
			'description' => esc_html__('Pentax Instagram Photo Widget','pentax'),
		));
	}
	...
	public function form($instance){
		$title      = isset( $instance['title'] ) ? $instance['title'] : esc_html__('Instagram', 'pentax');
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'insta_user' ) ); ?>"><?php esc_html_e( 'User Name:' ,'pentax'); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'insta_items' ) ); ?>"><?php esc_html_e( 'Item Number:' ,'pentax'); ?></label>
...
if(!function_exists('pentax_instagram_widgets')):
	function pentax_instagram_widgets(){
		register_widget('pentax_instagram_photo');
	}
	add_action('widgets_init','pentax_instagram_widgets');
endif;
