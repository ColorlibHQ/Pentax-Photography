...
class Pentax_social_links extends WP_Widget {
    ...
    function __construct() {
        ...
        esc_html__( '[ Pentax ] Social Links', 'pentax' ),

        // Widget description
        array( 'description' => esc_html__( 'Add footer social links.', 'pentax' ), )
        );
    ...
    public function form( $instance ) {
        ...
        $title = isset( $instance[ 'title' ] ) ? $instance[ 'title' ] : esc_html__( 'Follow Us', 'pentax' );
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'facebook' ) ); ?>"><?php esc_html_e( 'Facebook URL:' ,'pentax'); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'twitter' ) ); ?>"><?php esc_html_e( 'Twitter URL:' ,'pentax'); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'linkedin' ) ); ?>"><?php esc_html_e( 'Linkedin URL:' ,'pentax'); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'behance' ) ); ?>"><?php esc_html_e( 'Behance URL:' ,'pentax'); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'dribbble' ) ); ?>"><?php esc_html_e( 'Dribbble URL:' ,'pentax'); ?></label>
...
} // Class pentax_social_links ends here


// Register and load the widget
function pentax_social_links_widget_load() {
	register_widget( 'Pentax_social_links' );
}
add_action( 'widgets_init', 'pentax_social_links_widget_load' );