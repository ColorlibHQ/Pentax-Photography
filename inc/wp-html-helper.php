...
// image default alt
if( !function_exists( 'pentax_img_default_alt' ) ){
	function pentax_img_default_alt( $url = '' ){
...
// Image Tag
if( !function_exists( 'pentax_img_tag' ) ){
	function pentax_img_tag( array $args ){
		...
		if( !empty( $args['alt'] ) ){
			...
			$alt = pentax_img_default_alt( $url );
		}
...
// Anchor Tag
if( !function_exists( 'pentax_anchor_tag' ) ){
	function pentax_anchor_tag( array $args ){
...
// Heading Tag
if( !function_exists( 'pentax_heading_tag' ) ){
	function pentax_heading_tag( array $args ){
...
// Paragraph Tag
if( !function_exists( 'pentax_paragraph_tag' ) ){
	function pentax_paragraph_tag( array $args ){
...
// Other Tag
if( !function_exists( 'pentax_other_tag' ) ){
	function pentax_other_tag( array $args ){
...
// Button Element 
if( !function_exists( 'pentax_button_element ' ) ){
	function pentax_button_element( array $args ){
