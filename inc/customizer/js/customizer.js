(function( $ , api){
    ...
    api.section( 'pentax_fof_section' , function( section ){
    ...
    // Customizer about page redirect
    api.section( 'pentax_about_section' , function( section ){
    ...
    api.section( 'pentax_blog_section' , function( section ){
    ...
    api.section( 'pentax_contact_section' , function( section ){

        section.expanded.bind( function( isExpanded ){

            // Customizer contact form seclector 
            var customshortcodefield = $('#customize-control-pentax_contact_custom_formshortcode'),
                selector = $('#_customize-input-pentax_contact_formshortcode');
    ...
    // General section
    api.section( 'pentax_general_section' , function( section ){
        ...
        section.expanded.bind( function( isExpanded ){
            ...
            var $preloader      = $('#pentax_preloader_toggle'),
                $preloaderbg    = $( '#customize-control-pentax_preloader_bg_color' ),
                $preloadercolor = $( '#customize-control-pentax_preloader_color' );
            ...
            var $backtotop          = $( '#pentax_backtotop_btn' ),
                $backtotopbg        = $( '#customize-control-pentax_backtotop_btn_bg_color' ),
                $backtotophoverbg   = $( '#customize-control-pentax_backtotop_btn_hover_bg_color' );
    ...
    // Footer section
    api.section( 'pentax_footer_section' , function( section ){
        ...
        section.expanded.bind( function( isExpanded ){
            ...
            var $widget_toggle      = $('#pentax_footer_widget_toggle');
