    ...
    <div class="col-full">
        <div class="featured">
            ...
            <div class="featured__column featured__column--big">
                <?php 
                $term = pentax_opt( 'pentax_featured_cat' );
                ...
                ?>
                    <div class="entry" <?php echo pentax_inline_bg_img( get_the_post_thumbnail_url() ); ?>>
                        
                        <div class="entry__content">
                            <?php 
                            if( pentax_featured_post_cat() ){
                                echo '<span class="entry__category">'.pentax_featured_post_cat().'</span>';
                            }
                            ?>
